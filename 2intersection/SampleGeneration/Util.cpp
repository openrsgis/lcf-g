...
void getPartitionBoundary(double* gatherCI, int size, long cellNum, int* bounds, double* partitionCI)
{
	...
	for (int count = -20; count < 20; count++)
	{
		...
		// 打印 bounds_tmp 和 partitionCI_tmp
...
void callMlModel(const char* script, const char* funcName, const char* modelPath, const char* inputPath, const char* outputPath)
{
...
//{
//
//	const char* script = "/home/fgao/LoadBalance/Intersection/python/ml_env/dl/intersection/model_call.py";
//	const char* function = "resnet";
//	const char* modelPath = "/home/fgao/LoadBalance/Intersection/python/ml_env/dl/intersection/result_model/resnet2_rank1.pth";
//	const char* inputDir = "/home/fgao/LoadBalance/Intersection/data/rank/1";
//	const char* outputCIPath = "/home/fgao/LoadBalance/Intersection/data/rank/1/resnet_predict.txt";
//	callCnnModel(script, function, modelPath, inputDir, outputCIPath);
//
//	//removeFile("/home/fgao/LoadBalance/Intersection/model/test3/sample_image/", "shx");
//
//	//rasterize("/home/fgao/LoadBalance/Intersection/data/DLTB_3_LINE.shp", "/home/fgao/LoadBalance/Intersection/data/DLTB_3_LINE.tif");
//
